    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="mt-6 space-y-6 leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-2">
            Данные хранятся на серверах на территории Российской Федерации. Для связи с вами
            уведомление о заявке, включая имя и номер телефона, направляется специалистам
            колл-центра в мессенджер Telegram: отправляя заявку, вы соглашаетесь и с такой
            передачей. Данные не продаются и не передаются третьим лицам для рекламы.
          </p>
        </section>
        <section>
